/*
 ...
 Release Candidate 1.0 - 27/09/2015: Optimized code to display 7-seg Common Anode
 Release Candidate 2.0 - 25/10/2015: Optimized code to hall sensor A3144
*/
...
/*  
  // reference code to Common Cathode 
  // neutro '0'
  digitalWrite(2, 0);
  digitalWrite(3, 0);
  digitalWrite(4, 0);
